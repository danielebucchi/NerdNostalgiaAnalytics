...
from src.bot.handlers.deals import deals_command, vinted_command, vinted_page_callback, deals_page_callback
...
def create_bot() -> Application:
    ...
    app.add_handler(CallbackQueryHandler(deals_page_callback, pattern=r"^dp:"))
